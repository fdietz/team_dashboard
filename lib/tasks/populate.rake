...
task :populate => :environment do
  ...
  d1.widgets.create!(:name => "Two Targets Stacked Graph", :kind => 'graph', :size_x => 3, :size_y => 2, :source => 'demo', :settings => { :graph_type => 'area', :targets => [target1, target2].join(';'), :range => "30-minutes" })
  ...
  d2.widgets.create!(:name => "Two Targets Stacked Graph", :kind => 'graph', :size_x => 2, :size_y => 2, :source => 'demo', :settings => { :graph_type => 'area', :targets => [target1, target2].join(';'), :range => "30-minutes" })
