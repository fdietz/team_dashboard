...
task :populate => :environment do
  ...
  d1.widgets.create!(:name => "Two Targets Stacked Graph", :targets => [target1, target2].join(';'), :size => 3, :source => 'demo', :settings => { :graph_type => 'area' })
  ...
  d2.widgets.create!(:name => "Two Targets Stacked Graph", :targets => [target1, target2].join(';'), :size => 3, :source => 'demo', :settings => { :graph_type => 'area' })
