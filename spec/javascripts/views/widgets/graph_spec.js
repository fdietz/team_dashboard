...
//       });
//       this.view = new window.app.views.widgets.Flotr2Graph({ model: this.model });
//     });

//     it("renders default html correctly", function() {
//       this.view.render();
//       expect(this.view.$(".graph-container")).toExist();
//     });
//   });
...
//   //     expect(this.view.$(".flotr-canvas")).toExist();
//   //     expect(this.view.$(".flotr-labels")).toExist();
//   //   });
//   // });
// });